...
export default function MentorDashboard() {
  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden" dir="rtl">
      ...
      {/* Main */}
      <main className={`flex-1 main-content-gradient text-card-foreground ${isMobile ? 'pt-14 pb-20' : ''} ${activeTab === 'questions' ? 'overflow-hidden flex flex-col' : 'overflow-y-auto'}`}>
        <AnimatePresence mode="wait">
