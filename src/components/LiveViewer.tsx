                ...
                <div className="p-3 border-t border-border shrink-0">
                  <div className="flex gap-2">
                    <input
                      ...
                      maxLength={300}
                      className="flex-1 h-9 px-3 aurora-field rounded-xl text-xs text-foreground placeholder:text-muted-foreground focus:outline-none transition-all text-right"
                    />
                    <button
                      onClick={sendMessage}
