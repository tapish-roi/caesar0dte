    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="space-y-1.5">
        {arr.map((value, i) => {
          ...
          const stat = upper ? cached[upper] : undefined;
          return (
            <div key={i} className="flex items-center gap-2">
              ...
              />
              <div className="text-[10px] text-muted-foreground tabular-nums min-w-[80px] text-end">
                {stat ? `$${fmt(stat.close_price)} · ${fmt(stat.atr)}` : ''}
              </div>
              <Button
                type="button"
                variant="ghost"
